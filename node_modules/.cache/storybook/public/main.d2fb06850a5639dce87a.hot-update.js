...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".storybook-button {\n  \n}\n.storybook-button--secondary {\n  color: #333;\n  background-color: transparent;\n  box-shadow: rgba(0, 0, 0, 0.15) 0px 0px 0px 1px inset;\n}", "",{"version":3,"sources":["webpack://src/stories/button.css"],"names":[],"mappings":"AAAA;;AAEA;AACA;EACE,WAAW;EACX,6BAA6B;EAC7B,qDAAqD;AACvD","sourcesContent":[".storybook-button {\n  \n}\n.storybook-button--secondary {\n  color: #333;\n  background-color: transparent;\n  box-shadow: rgba(0, 0, 0, 0.15) 0px 0px 0px 1px inset;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.d2fb06850a5639dce87a.hot-update.js.map