...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".storybook-button {\n    \n  }\n  .storybook-button--secondary {\n    color: #333;\n    background-color: transparent;\n    box-shadow: rgba(0, 0, 0, 0.15) 0px 0px 0px 1px inset;\n  }", "",{"version":3,"sources":["webpack://src/components/wikiSearch/wikiSearch.css"],"names":[],"mappings":"AAAA;;EAEE;EACA;IACE,WAAW;IACX,6BAA6B;IAC7B,qDAAqD;EACvD","sourcesContent":[".storybook-button {\n    \n  }\n  .storybook-button--secondary {\n    color: #333;\n    background-color: transparent;\n    box-shadow: rgba(0, 0, 0, 0.15) 0px 0px 0px 1px inset;\n  }"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.250aceb3da42ae77efce.hot-update.js.map